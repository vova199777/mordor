...
extern "C"
{
	JNIEXPORT jboolean JNICALL Java_com_nvidia_dev_1one_NvEventQueueActivity_customMultiTouchEvent(JNIEnv* env, jobject thiz, jint action,
		jint pointer, jint x1, jint y1, jint x2, jint y2, jint x3, jint y3)
	{
...

		{
			...
			//Log("touch x1 %0.2f | y1 %0.2f | x2 %0.2f | y2 %0.2f | x3 %0.2f | y3 %0.2f", (float)x1, (float)y1, (float)x2, (float)y2, (float)x3, (float)y3);
